...
export default function CheckoutForm() {
  ...
  return (
    <form id="payment-form" onSubmit={handleSubmit} className="max-w-md mx-auto space-y-4">
      ...
      {message && <div id="payment-message" className="text-sm text-center mt-2">{message}</div>}
    </form>
  );
}
